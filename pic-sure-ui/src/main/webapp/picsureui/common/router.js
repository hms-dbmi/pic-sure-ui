define(["text!settings/settings.json","common/searchParser", "header/header", "backbone", "common/queryBuilderView"],
        function(settings, searchParser, header, Backbone, queryBuilderView){
